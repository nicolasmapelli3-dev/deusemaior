...
const Index = () => {
  return (
    <div className="min-h-screen bg-[hsl(30,25%,96%)] flex flex-col font-['Plus_Jakarta_Sans',sans-serif]">
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-3">
        <div className="w-10" />
        <h1 className="text-xl font-bold tracking-[0.15em] text-[hsl(30,10%,20%)] font-['Plus_Jakarta_Sans',sans-serif]">
          DUOMO
        </h1>
      ...
      <main className="flex-1 flex flex-col items-center px-4 pt-6 pb-8 max-w-lg mx-auto w-full">
        ...
        <div className="text-center mb-2">
          <h2 className="text-2xl md:text-3xl font-bold text-[hsl(30,10%,15%)] tracking-wide leading-tight font-['Plus_Jakarta_Sans',sans-serif]">
            DESCUBRA SEU
            <br />
        ...
        <div className="flex gap-3 w-full max-w-md mb-8">
          {/* Male Card */}
          <button className="relative flex-1 rounded-2xl overflow-hidden group cursor-pointer transition-transform hover:scale-[1.02] active:scale-[0.98]">
            <img
